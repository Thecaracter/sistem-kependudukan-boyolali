        ...
        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="role" id="roleSelect" onchange="toggleDesaField()" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                ...
                <div id="desaField" style="display: none;">
                    <label class="block text-sm font-medium text-gray-700">Desa</label>
                    <select name="id_desa" id="desaSelect"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
   ...
   <dialog id="editModal">
           ...
           <form id="editForm" method="POST" enctype="multipart/form-data">
               ...
               <div class="space-y-4">
                   <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Role</label>
                        <select name="role" id="edit_role" onchange="toggleEditDesaField()" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                            <option value="">Pilih Role</option>
                            @foreach ($roles as $role)
                    ...
                    <div id="edit_desa_field" style="display: none;">
                        <label class="block text-sm font-medium text-gray-700">Desa</label>
                        <select name="id_desa" id="edit_desa"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                            <option value="">Pilih Desa</option>
                            @foreach ($desas as $desa)
    ...
    <dialog id="deleteModal">
        <div class="modal-box">
            ...
            <p class="text-gray-600 mb-4">Apakah Anda yakin ingin menghapus user ini? Tindakan ini tidak dapat dibatalkan.</p>
 ...
 @push('scripts')
    <script>
        function toggleDesaField() {
            ...
            const desaRoles = ['Operator Desa', 'Validator Desa', 'Kades'];
 
            if (desaRoles.includes(roleSelect.value)) {
        ...
        function toggleEditDesaField() {
            const roleSelect = document.getElementById('edit_role');
            const desaField = document.getElementById('edit_desa_field');
        ...
        function editUser(userData) {
            ...
            const desaSelect = document.getElementById('edit_desa');
            if (userData.id_desa) {
                desaSelect.value = userData.id_desa;
            }
